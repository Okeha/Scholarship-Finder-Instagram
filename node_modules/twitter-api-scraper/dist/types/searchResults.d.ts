...
export declare enum AdvertiserAccountType {
    None = "none",
...
export declare enum ProfileSidebarBorderColor {
    C0Deed = "C0DEED",
    Ffffff = "FFFFFF",
    The000000 = "000000"
}
export declare enum ProfileSidebarFillColor {
    Ddeef6 = "DDEEF6",
    F5Deb3 = "F5DEB3",
    The000000 = "000000"
}
export declare enum TranslatorType {
    None = "none",
    Regular = "regular"
}
...
export declare type Instruction = AddEntryInstruction;
...
export declare enum PurpleElement {
    Tweet = "tweet",
    User = "user"
}
...
export declare enum FluffyElement {
...
export declare enum FeedbackKey {
